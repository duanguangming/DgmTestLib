...
#ifndef BSYSerializeKit_h
#define BSYSerializeKit_h
 ...
 *  BSYSerializeKit在运行时对类以及所有层级父类的变量进行遍历，避免遗漏。属性越多，优势越明显。
 *
 * Usage:
 *
 * Person.h:
 * ========================================
 *    #import "BSYSerializeKit.h"
 *
 ...
 *
 *  BSYSERIALIZE_CODER_DECODER();
 *  BSYSERIALIZE_COPY_WITH_ZONE();
 *  BSYSERIALIZE_DESCRIPTION();//(NOT NECESSARY)
 *
 *    @end
 * ========================================
 *
 ...
 *      BSYSERIALIZE_ARCHIVE(person, @"Person", [self filePath]);
 *
 *      //unarchive NSData to object
 *      Person *thePerson = nil;
 *      BSYSERIALIZE_UNARCHIVE(thePerson, @"Person", [self filePath]);
 */

#define BSYSERIALIZE_CODER_DECODER()     \
\
...
#define BSYSERIALIZE_COPY_WITH_ZONE()  \
\
...
#define BSYSERIALIZE_DESCRIPTION() \
\
...
/* 封装归档keyedArchiver操作 */
#define BSYSERIALIZE_ARCHIVE(__objToBeArchived__, __key__, __filePath__)    \
\
...
#define BSYSERIALIZE_UNARCHIVE(__objToStoreData__, __key__, __filePath__)   \
