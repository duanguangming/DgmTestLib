 ...
 */
typedef void (^MJPropertiesEnumeration)(BSYMJProperty *property, BOOL *stop);
...
/** 用于过滤字典中的值 */
typedef id (^MJNewValueFromOldValue)(id object, id oldValue, BSYMJProperty *property);
...
+ (id)mj_getNewValueFromObject:(__unsafe_unretained id)object oldValue:(__unsafe_unretained id)oldValue property:(__unsafe_unretained BSYMJProperty *)property;
